...
public class Copy_2_of_MediaManage implements Observer {
	private static Copy_2_of_MediaManage _mediaManage;
	...
	public Copy_2_of_MediaManage(Context context) {
		this.context = context;
		init(context);
	}

	public static Copy_2_of_MediaManage getMediaManage(Context context) {
		if (_mediaManage == null) {
			_mediaManage = new Copy_2_of_MediaManage(context);
		}
		return _mediaManage;
	}
	...
	private void init(Context context) {
		...
		ObserverManage.getObserver().addObserver(Copy_2_of_MediaManage.this);
	}
