...
public class CopyOfFloatLrcService extends Service implements Observer {
	...
	private void init() {
		...
		context = CopyOfFloatLrcService.this.getBaseContext();
	...
	public void onDestroy() {
		...
		if (!Constants.APPCLOSE) {
			...
			startService(new Intent(this, CopyOfFloatLrcService.class));
		}
	}
