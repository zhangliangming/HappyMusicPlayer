...
//public class CopyOfLocalMusicFragment extends Fragment implements Observer,
//		OnScrollListener {
...
//
//	private ImageButton deleteSongImageButton;
//
...
//	};
//
//	public CopyOfLocalMusicFragment(PageAction action) {
//		this.action = action;
//	}
//
//	@Override
...
//			if (isDelete) {
//				isDelete = false;
//				confirmImageButton.setVisibility(View.INVISIBLE);
//				deleteSongImageButton.setVisibility(View.VISIBLE);
//				if (adapter != null) {
...
//				});
//
//		deleteSongImageButton = (ImageButton) mMainView
//				.findViewById(R.id.delete_song);
//
//		deleteSongImageButton.setVisibility(View.VISIBLE);
//
//		deleteSongImageButton.setOnClickListener(new OnClickListener() {
//
//			@Override
//			public void onClick(View arg0) {
//				isDelete = true;
//				confirmImageButton.setVisibility(View.VISIBLE);
//				deleteSongImageButton.setVisibility(View.INVISIBLE);
//				if (adapter != null) {
//					adapter.setDelete(isDelete);
//					adapter.setSelectList(new ArrayList<String>());
//					adapter.notifyDataSetChanged();
...
//		});
//
//		confirmImageButton = (ImageButton) mMainView.findViewById(R.id.confirm);
//
//		confirmImageButton.setVisibility(View.INVISIBLE);
//
//		confirmImageButton.setOnClickListener(new OnClickListener() {
//
//			@Override
//			public void onClick(View arg0) {
//				isDelete = false;
...
//		if (isDelete) {
//			localMusicLocateRelativeLayout.setVisibility(View.INVISIBLE);
//			return;
//		}
//
//		// 滑动停止
