...
public class Copy_4_of_KscManyLineLyricsView extends View implements Observer {
	/**
	 * 是否有歌词
	 */
	...
	public Copy_4_of_KscManyLineLyricsView(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public Copy_4_of_KscManyLineLyricsView(Context context) {
		super(context);
		init(context);
	}
